...
import './style/singleApratment.css'
...
class SingleApartment extends React.Component {
    ...
    render() {
        const {apartment, images, user} = this.state;
                            ...
                            <div className={"row flex-nowrap "}>
                                ...
                                <div className={"col-auto d-flex justify-content-between"}>
                                    ...
                                    <ul className={"nav-bar-list nav-bar d-flex"}>
                                        <li  className={"d-flex "}>
                                            <img alt={"preson-icon"} src="https://img.icons8.com/pastel-glyph/64/000000/christmas-boy--v1.png" style={{width:"30px"}}/>
